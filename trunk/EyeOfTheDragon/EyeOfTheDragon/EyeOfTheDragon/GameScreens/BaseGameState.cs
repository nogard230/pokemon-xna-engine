...
namespace EyesOfTheDragon.GameScreens
{
    public abstract partial class BaseGameState : GameState
    {
        ...
        protected TimeSpan transitionInterval = TimeSpan.FromSeconds(0.75);

        protected Texture2D EmptyTexture;
        ...
        protected override void LoadContent()
        {
            ...
            EmptyTexture = Content.Load<Texture2D>(@"Backgrounds\pixel");
        ...
        protected void FadeBackBufferTo(SpriteBatch spriteBatch, Color color, float alpha, Rectangle bounds)
        {
            spriteBatch.Draw(EmptyTexture, new Rectangle(bounds.X, bounds.Y, bounds.Width, bounds.Height), color * alpha);
        }
